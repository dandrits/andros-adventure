...
class Validator {
   ...
   public static function IsDate($date, $format = 'Y-m-d H:i:s')
    ...
    /**
     *
     * Forces the variable to quote.
     *
     * @return mixed Variable with quote.
     *
     */
    public static function ToQuote($value){
        return "'$value'";
    }

    /**
     *
     * Validates that the value is a time type representation of various format
     *
     * @return bool True if valid, false if not.
     */
   public static function IsTime($time)
    {
     ...
     if ($tm[0] < 0 || $hour > 23 || !is_numeric($tm[0])) {
         return false;
     }
     if ($tm[1] < 0 || $tm[1] > 59 || !is_numeric($tm[1])) {
         return false;
     }
     if ($tm[2] < 0 || $tm[2] > 59 || !is_numeric($tm[2])) {
         return false;
     }
     return true;
    }
    ...
    /**
     *
     * Forces the value to time format with trim property.
     *
     * @return string Value as trimmed time type if true, null if false.
     *
     */
    ...
    /**
     *
     * Validates that the value sepehr/6351385is a timestamp type representation of various format
     * source code from https://gist.github.com/sepehr/6351385
     *
     * @return bool True if valid, false if not.
     */
   public static function IsTimeStamp($timestamp)
    ...
    /**
     *
     * Forces the value to timestamp format with trim property.
     *
     * @return string Value as trimmed time type if true, null if false.
     *
     */
    ...
    protected static $timeFlagValues = array('start','intermediate','stop');
    protected static $dateChoiceValues = array('day','month','year');
    
    /**
     *
     * Validates that the value has valid mac address format.
     *
     * @return bool True if valid, false if not.
     */
    public static function IsMacAddress($value){
